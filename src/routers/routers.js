...
mongoose.connect("mongodb+srv://rameshgharami374:Ramesh123@cluster0.ikyammj.mongodb.net/", {
...
db.once("open", (_) => {
    console.log("mongodb+srv://rameshgharami374:Ramesh123@cluster0.ikyammj.mongodb.net/");
});
db.on("error", (err) => {
